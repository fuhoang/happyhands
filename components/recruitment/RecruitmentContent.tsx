        ...
        <InfoCard className="p-8 sm:p-10">
          ...
          <ul className="mt-8 grid gap-4 sm:grid-cols-2">
            {benefits.map((benefit) => (
              <li key={benefit.label} className="flex items-start gap-3 rounded-sm border border-[#d8e8d8] bg-[#f9fcf9] px-4 py-4">
                ...
                <span className="text-sm font-semibold leading-7 text-[#163316]">{benefit.label}</span>
              </li>
            ))}
          </ul>
        </InfoCard>
          ...
          <InfoCard className="p-8 sm:p-10">
            ...
            <form className="mt-8 grid gap-10">
              ...
              <div className="flex flex-wrap gap-3">
                ...
                <a
                  href="mailto:happyhandscustomerservice@gmail.com?subject=Cleaner%20Application"
