  ...
  return (
    <main className="min-h-screen bg-white text-[#1f2a1f]">
      ...
      <section className="relative overflow-hidden border-b border-[#d7e6d7] bg-[#0f4d0f]">
        <div className="absolute inset-0 bg-[url('https://images.pexels.com/photos/7937325/pexels-photo-7937325.jpeg?auto=compress&cs=tinysrgb&w=1600')] bg-cover bg-center bg-no-repeat" />
        <div className="absolute inset-0 bg-[linear-gradient(135deg,rgba(15,77,15,0.76)_0%,rgba(24,96,24,0.66)_55%,rgba(47,138,47,0.5)_100%)]" />
        <div className="relative mx-auto max-w-5xl px-5 py-20 sm:px-8 lg:px-10">
          <p className="text-sm font-black uppercase tracking-[0.18em] text-white/80">Case Study</p>
          ...
          <p className="mt-6 max-w-3xl text-lg leading-8 text-white/82">
            A placeholder case study page for Zebra Housing, ready for project background, cleaning scope, delivery challenges and outcome metrics.
          </p>
        </div>
      </section>
        ...
        <div className="grid gap-8 lg:grid-cols-[1.15fr_0.85fr]">
          <article className="rounded-md border border-[#d7e6d7] bg-white p-8 shadow-[0_18px_40px_rgba(20,51,22,0.08)]">
            ...
            <h2 className="mt-3 text-4xl font-black tracking-[-0.05em] text-[#5a160d]">
              Ready for the full client story
            </h2>
            <div className="mt-6 space-y-5 text-base leading-8 text-[#5f7d69]">
              <p>
                Use this page to present the Zebra Housing brief, the cleaning challenges involved, the service scope delivered by Happy Hands, and the operational outcome for the client.
              </p>
              <p>
                The structure is set up for a professional case study format and can be expanded with timelines, before-and-after detail, property volumes, compliance requirements, and measurable results.
              </p>
            </div>
          </article>
          ...
          <aside className="rounded-md border border-[#d7e6d7] bg-[#fbfffb] p-8 shadow-[0_18px_40px_rgba(20,51,22,0.06)]">
            ...
            <ul className="mt-6 space-y-4 text-sm leading-7 text-[#5f7d69]">
              <li>Client background and property type</li>
              <li>Cleaning brief and service requirements</li>
              <li>Operational challenges and scheduling</li>
              <li>Delivery approach and standards maintained</li>
              <li>Results, outcomes and client value</li>
            </ul>
          </aside>
        </div>
      </section>

      <section className="bg-[#0f4d0f] px-5 py-16 text-white sm:px-8 lg:px-10">
        <div className="mx-auto max-w-5xl rounded-md border border-white/15 bg-white/6 p-8 backdrop-blur-sm">
          <p className="text-sm font-black uppercase tracking-[0.2em] text-[#caffca]">Need a similar outcome?</p>
          <h2 className="mt-4 text-4xl font-black tracking-[-0.05em] sm:text-5xl">
            Talk to Happy Hands about your cleaning requirements.
          </h2>
          <div className="mt-8 flex flex-wrap gap-4">
            ...
            <a
              href="mailto:happyhandscustomerservice@gmail.com"
              className="inline-flex min-h-14 items-center justify-center rounded-sm border border-white/35 px-7 text-sm font-black text-white transition hover:bg-white/10"
            >
              Get Quote
            </a>
          </div>
      ...
      <footer className="border-t border-[#b8d6c1]/50 bg-white">
        <div className="mx-auto flex w-full max-w-7xl flex-col items-center gap-4 px-5 py-6 text-center text-sm text-[#5f7d69] sm:px-8 lg:px-10">
          <div className="grid w-full max-w-6xl gap-8 text-left md:grid-cols-2 xl:grid-cols-4">
            <div>
              <h3 className="mb-3 text-sm font-black uppercase tracking-[0.14em] text-[#008000]">Explore</h3>
            ...
            <div>
              <h3 className="mb-3 text-sm font-black uppercase tracking-[0.14em] text-[#008000]">Services</h3>
              <ul className="space-y-2">
                ...
                <li><Link href="/services/rental-turnovers" className="transition hover:text-[#008000]">Rental Turnovers</Link></li>
                <li><Link href="/services/washing-and-ironing" className="transition hover:text-[#008000]">Washing and Ironing</Link></li>
                <li><Link href="/services/leisure-and-hospitality-cleaning" className="transition hover:text-[#008000]">Leisure and Hospitality Cleaning</Link></li>
              </ul>
            </div>

            <div>
              <h3 className="mb-3 text-sm font-black uppercase tracking-[0.14em] text-[#008000]">Case Studies</h3>
              <ul className="space-y-2">
            ...
            <div>
              <h3 className="mb-3 text-sm font-black uppercase tracking-[0.14em] text-[#008000]">Become a Happy Hand Cleaner!</h3>
