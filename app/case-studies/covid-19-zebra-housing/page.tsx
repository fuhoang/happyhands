  ...
  return (
    <main className="min-h-screen bg-white text-[#1f2a1f]">
      ...
      <section className="relative overflow-hidden border-b border-[#d7e6d7] bg-[#0f4d0f]">
        <div className="absolute inset-0 bg-[url('https://images.pexels.com/photos/3952234/pexels-photo-3952234.jpeg?auto=compress&cs=tinysrgb&w=1600')] bg-cover bg-center bg-no-repeat" />
        <div className="absolute inset-0 bg-[linear-gradient(135deg,rgba(15,77,15,0.82)_0%,rgba(24,96,24,0.72)_55%,rgba(47,138,47,0.54)_100%)]" />
        <div className="relative mx-auto max-w-5xl px-5 py-20 sm:px-8 lg:px-10">
          ...
          <p className="mt-6 max-w-3xl text-lg leading-8 text-white/82">
            A dedicated case study page for Covid-related cleaning delivery at Zebra Housing, ready for sanitisation scope, compliance detail and service outcomes.
          </p>
        </div>
      </section>
      ...
      <section className="bg-[#0f4d0f] px-5 py-16 text-white sm:px-8 lg:px-10">
        <div className="mx-auto max-w-5xl rounded-md border border-white/15 bg-white/6 p-8 backdrop-blur-sm">
          ...
          <h2 className="mt-4 text-4xl font-black tracking-[-0.05em] sm:text-5xl">
            Talk to Happy Hands about compliant cleaning support.
          </h2>
