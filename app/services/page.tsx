        ...
        <div className="grid gap-5 md:grid-cols-2 xl:grid-cols-3">
          {services.map((service) => (
            <Link
              ...
              className="rounded-md border border-[#d7e6d7] bg-white p-7 shadow-[0_18px_40px_rgba(20,51,22,0.08)] transition hover:-translate-y-1 hover:border-[#b7ddb7]"
            >
              <p className="text-xs font-black uppercase tracking-[0.18em] text-[#008000]">
                Service
              </p>
              <h2 className="mt-3 text-2xl font-black tracking-[-0.04em] text-[#163316]">
                {service.title}
              </h2>
