    ...
    (
      ...
      >
        ...
        <div style={{ display: "flex", flexDirection: "column", gap: "20px" }}>
          ...
          >
            Professional cleaning for homes, workplaces, and specialist spaces.
          </div>
          <div
            style={{
              fontSize: "28px",
          ...
          >
            Domestic, office, event, retail, hospitality, and managed property
            cleaning across London and the Home Counties.
          </div>
        </div>
